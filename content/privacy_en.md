...
The app stores the child's communication level, primary goal, practice history and settings. This also includes language and voice preferences, favourite and hidden cards, and custom cards with photos of family members or classmates. This information helps tailor content and resume practice.
...
## Usage statistics
The current version sends pseudonymous information about interactions within the app to PAN | DA's own server. Each installation is identified by a randomly generated ID that cannot be linked back to any person. This describes what users tap and which parts of the app they use. It helps us understand app usage and improve the app.

We do not attach photos or the child's name to these statistics.

We also use GoatCounter (gc.zgo.at) to count visits to our website. GoatCounter collects no cookies and no personal data — only page views and referring URLs.

Usage data is retained for up to 24 months and is not shared with third parties. To opt out of in-app statistics, disable Wi-Fi and mobile data on your device.
