...
## Eliminar dados
Pode eliminar os dados locais apagando a app do dispositivo. Dados sincronizados através do iCloud também podem precisar de ser removidos nas definições do iCloud.

## Alterações a esta política
Podemos atualizar esta política quando a app mudar. A versão mais recente será publicada nesta página.
